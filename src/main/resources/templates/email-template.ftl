                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom:25px">
                            ...
                            <p style="font-size: 14px; color: #6576ff; padding-top: 12px;">Campground theme</p>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding: 0 30px 20px">
                            ...
                            <p style="margin-bottom: 10px;">Welcome! <br> We are writing to you regarding the recent password reset requests made on our site. Our system has detected that there have been multiple password reset attempts associated with your account. While we understand that this may be a genuine need on your part, it could also be indicative of a potential security issue such as unauthorized access to your account.

                                We take the security of our users very seriously and we want to ensure that your account remains safe and secure at all times.
                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding:25px 20px 0;">
                            ...
                            <p style="padding-top: 15px; font-size: 12px;">This email was sent to you as a registered user of <a style="color: #6576ff; text-decoration:none;" href="">campground.com</a>. To update your emails preferences <a style="color: #6576ff; text-decoration:none;" href="#">click here</a>.</p>
                        </td>
                    </tr>
                    </tbody>
                </table>
